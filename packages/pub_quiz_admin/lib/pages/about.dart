    ...
    return section([
      ol([
        ...
        li([
          h3([text('📦 Ecosystem')]),
          text(
            'Get official packages and integrations for your project like '
            'jaspr_router, jaspr_tailwind or jaspr_riverpod. Find packages '
            'built for Jaspr on pub.dev using the ',
          ),
